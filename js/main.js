...
const professores = {
    ...
    FelipeBase: { nome: "Felipe O Físico", preco: 2500, bonus: 7, img: "assets/FelipeBase.jpeg", background: "url('assets/Fisica.jpg')" },
 Richardson: { nome: "Master Rick", preco: 7500, bonus: 11, img: "assets/FelipeBase.jpeg", background: "url('assets/Fisica.jpg')" },
    silviogoat: { nome: "Silvio Goat", preco: 1000, bonus: 13, img: "assets/Silviogoat.jpeg", background: "url('assets/ibura.jpg')" },
    silviofurry: { nome: "Silvio Furry", preco: 30000, bonus: 13, img: "assets/silviogoatfurry.png", background: "url('assets/academia.jpg')" },
